...
class TestClientInstance:
    ...
    def test_get_specific_client(self, client: TestClient, client_instance: ClientModel):
    ...
    def test_get_client_from_project(self, client: TestClient, client_instance: ClientModel):
    ...
    def test_put_client_project_not_found(self, client: TestClient, client_instance: ClientModel):
